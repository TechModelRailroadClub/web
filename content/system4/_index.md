...
System 4 is currently being developed as a replacement for [System 3](/system3/), the current control system of the Tech Nickel Plate. The design of System 4 revolves around an updated [Block Card](/system4/block_cards/), serving as a carrier board for an Arduino Nano compatible 3.3V microcontroller.

## Features
- DCC Support
- LCC Compliant
- More Compact [Block Cards](/system4/block_cards/) using Arduino Nano-Format Microprocessors (Easily Upgradable)
- More Scalable than System 3
- Compatibility with Commercially Available [Wireless Hardware Throttles](/system4/throttles/) and [Wireless Throttle Apps](/system4/throttles/)
- [Web-based Layout Control Software](/system4/web_control/)
- Fully Open Source
